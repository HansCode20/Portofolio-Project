    ...
    <div className='w-full mt-20'>
      <div className='bg-black text-gray-300'>
          ...
          <div className='flex lg:flex-row flex-col gap-14'>
            <div>
              ...
              <ul className='text-md'>
                <Link to="home" spy={true} smooth={true} duration={500} offset={-300}>
        ...
        <div className='p-5 mt-[-30px]'>
          ...
          <p className='text-sm lg:text-md font-bold text-center'>© 2023 Mokhamad Ilham Fanani. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
